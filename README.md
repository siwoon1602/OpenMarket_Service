...
|  3  |    결제예정금액    | 선택한 상품의 금액과 상품할인 배송비를 합친 결제 예정 금액을 자동으로 계산 | ✅  |
|  4  |   개별 주문하기    | list 우측의 주문하기 버튼 클릭시 단일상품 order 생성                       | ✅  |
|  5  | 장바구니 주문하기  | 최하단 주문하기 버튼 클릭시 장바구니 전체 상품 order 생성                  | ✅  |
|  6  | 장바구니 삭제하기  | 우측상단 x버튼 클릭시 장바구니에서 상품 삭제                               | ✅  |
|  7  | 단일 상품 선택하기 | 좌측 checkbox 로 주문할 상품선택 가능                                      | ✅  |
|  8  | 전체 상품 선택하기 | 모든 상품을 선택 or 선택해제 가능                                          | ✅  |

<br>
| 📌  |  주문페이지   | 내용                                                             |     |
| :-: | :-----------: | :--------------------------------------------------------------- | :-: |
|  1  | Page Open 시  | 사용자가 주문할 상품을 불러오고 화면에 보여줌                    | ✅  |
|  2  | 총 주문 금액  | 주문할 상품 과 배송비를 계산하여 결제 금액을 알려줌              | ✅  |
|  3  |  유효성 검사  | 모든 input 입력 + 결제수단선택 + checkbox 동의시 결제하기 활성화 | ✅  |
|  4  | 개별 주문하기 | list 우측의 주문하기 버튼 클릭시 단일상품 order 생성             | ✅  |
|  5  | 우편번호 조회 | 우편번호조회 버튼 클릭시 우편번호 검색이 가능한 팝업 생성        | ✅  |
|  6  |   결제하기    | 결제성공시 이전페이지로 이동                                     | ✅  |

<br>
| 📌  |  주문페이지   | 내용                                                                       |     |
| :-: | :----------------: | :------------------------------------------------------------------------- | :-: |
|  1  |    Page Open 시    | 사용자가 주문한 상품을 불러오고 화면에 보여줌                     | ✅  |
|  2  | 주문 상태 확인  | 현재 주문한 상품의 주문 상태를 보여줌                                | ✅  |
|  3  |    상세보기     | 해당 주문의 상세정보를 확인할 수 있는 페이지로 이동함  |  ✅ |
